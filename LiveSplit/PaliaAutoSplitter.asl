...
{
        double x : 0x0ABBA830, 0x0, 0x90, 0x348, 0x1F0;
        double y : 0x0ABBA830, 0x0, 0x90, 0x348, 0x1F8;
        double z : 0x0ABBA830, 0x0, 0x90, 0x348, 0x200;
}
state("PaliaClientSteam-Win64-Shipping")
{
        double x : 0x0AC2CAB0, 0x0, 0x90, 0x348, 0x1F0;
        double y : 0x0AC2CAB0, 0x0, 0x90, 0x348, 0x1F8;
        double z : 0x0AC2CAB0, 0x0, 0x90, 0x348, 0x200;
}
