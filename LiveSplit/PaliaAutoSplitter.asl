...
{
        double x : 0x08EE8458, 0x0, 0x20, 0x1A0, 0x260;
        double y : 0x08EE8458, 0x0, 0x20, 0x1A0, 0x268;
        double z : 0x08EE8458, 0x0, 0x20, 0x1A0, 0x270;
}

state("PaliaClientSteam-Win64-Shipping")
{
        double x : 0x08FAD718, 0x0, 0x20, 0x1A0, 0x260;
        double y : 0x08FAD718, 0x0, 0x20, 0x1A0, 0x268;
        double z : 0x08FAD718, 0x0, 0x20, 0x1A0, 0x270;		
}
