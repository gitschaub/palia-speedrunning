...
{
        double x : 0x0AD4D2B0, 0x30, 0x360, 0x1B8, 0x1F0;
        double y : 0x0AD4D2B0, 0x30, 0x360, 0x1B8, 0x1F8;
        double z : 0x0AD4D2B0, 0x30, 0x360, 0x1B8, 0x200;
}
state("PaliaClientSteam-Win64-Shipping")
{
        double x : 0x0ADC1530, 0x30, 0xD00, 0x348, 0x1F0;
        double y :  0x0ADC1530, 0x30, 0xD00, 0x348, 0x1F8;
        double z : 0x0ADC1530, 0x30, 0xD00, 0x348, 0x200;
}
