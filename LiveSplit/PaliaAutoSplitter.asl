...
{
        double x : 0x0AD18870, 0x0, 0x90, 0x338, 0x1F0;
        double y : 0x0AD18870, 0x0, 0x90, 0x338, 0x1F8;
        double z : 0x0AD18870, 0x0, 0x90, 0x338, 0x200;
}
state("PaliaClientSteam-Win64-Shipping")
{
        double x : 0x0AD7C070, 0x30, 0x2E8, 0x1B8, 0x1F0;
        double y :  0x0AD7C070, 0x30, 0x2E8, 0x1B8, 0x1F8;
        double z : 0x0AD7C070, 0x30, 0x2E8, 0x1B8, 0x200;
}
